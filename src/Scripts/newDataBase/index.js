...
db.getCollection("configurations").insertMany([
    {
        "_id" : ObjectId("63eb4570a8a626f3c590a1fa"),
    ...
    {
        "_id" : ObjectId("641d3f0c1752dc44e63e2b10"),
        "name" : "discounts",
        "types" : {
            "data" : {
    ...
    {
        "_id" : ObjectId("641d40381752dc44e63e2b11"),
        "name" : "brandAndUserPrice",
        "types" : {
            "data" : {
                "brand" : {
                    "brandPrice" : 10.0,
                    "price_id_monthly" : "price_1Msk9RSGnhxQu4RMGST05bb0",
                    "price_id_yearly" : "price_1MsVHJSGnhxQu4RM0eVGOCsh"
                },
                "user" : {
                    "userPrice" : 10.0,
                    "price_id_monthly" : "price_1Msk8hSGnhxQu4RMD7iYaRe9",
                    "price_id_yearly" : "price_1MsVI0SGnhxQu4RMAVEF2BTU"
                }
            }
        }
    }
